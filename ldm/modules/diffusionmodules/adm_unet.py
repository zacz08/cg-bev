...
class DhariwalUNet(nn.Module):
    def __init__(self,
        ...
        **kwargs
        ...
        # self.out_conv = Conv2d(in_channels=cout, out_channels=out_channels*out_mul, kernel=3, **init_one)

        self.out = nn.Sequential(
            GroupNorm(num_channels=cout),
            nn.SiLU(),
            zero_module(Conv2d(in_channels=cout, out_channels=out_channels*out_mul, kernel=3, **init_one))
        )
...
class EDMPrecond(nn.Module):
    def __init__(self,
        ...
        **model_kwargs,                     # Keyword arguments for the underlying model.
        ...
        self.unet = globals()[model_type](img_resolution=img_resolution, in_channels=img_channels, out_channels=img_channels, label_dim=label_dim, **model_kwargs)
    ...
    def forward(self, x, sigma, class_labels=None, force_fp32=False, *args, **model_kwargs):
        ...
        F_x = self.unet((c_in * x).to(dtype), c_noise.flatten(), class_labels=class_labels, **model_kwargs)
